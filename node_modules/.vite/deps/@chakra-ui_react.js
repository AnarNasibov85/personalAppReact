...
} from "./chunk-6RGOJMY2.js";
import {
  require_jsx_runtime
} from "./chunk-CTRIHH5C.js";
import {
  require_react_is
} from "./chunk-OSHGVTKH.js";
import {
  require_react_dom
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  const { nonce } = (0, import_react28.useContext)(MotionConfigContext);
...
var focusScope = (0, import_react92.createContext)(void 0);
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react96.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react96.useCallback)(() => {
    var _a2;
...
function usePrevious(value) {
  const ref = (0, import_react97.useRef)();
...
function useShortcut(props = {}) {
  ...
  const [keys, setKeys] = (0, import_react98.useState)([]);
  const timeoutRef = (0, import_react98.useRef)();
  const flush = () => {
  ...
  (0, import_react98.useEffect)(() => flush, []);
...
var useSafeLayoutEffect3 = isBrowser ? import_react99.useLayoutEffect : import_react99.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react100 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react100.useRef)(fn2);
  useSafeLayoutEffect3(() => {
    ref.current = fn2;
  });
  return (0, import_react100.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react102.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react107.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react108.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react110.useRef)(null);
  const handlers2 = {
...
function useId6(idProp, prefix) {
  const id3 = (0, import_react111.useId)();
...
function useOptionalPart(partId) {
  const [id3, setId] = (0, import_react111.useState)(null);
  const ref = (0, import_react111.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react112.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react112.useCallback)(
    (next) => {
...
function useDisclosure(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react113.useState)(props.defaultIsOpen || false);
  const [isControlled, isOpen] = useControllableProp(isOpenProp, isOpenState);
  const id3 = useId6(idProp, "disclosure");
  const onClose = (0, import_react113.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    onClosePropCallbackRef == null ? void 0 : onClosePropCallbackRef();
  }, [isControlled, onClosePropCallbackRef]);
  const onOpen = (0, import_react113.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    onOpenPropCallbackRef == null ? void 0 : onOpenPropCallbackRef();
  }, [isControlled, onOpenPropCallbackRef]);
  const onToggle = (0, import_react113.useCallback)(() => {
...
function useEventListenerMap() {
  ...
  const add = (0, import_react114.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react114.useCallback)(
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react115.useRef)(false);
  const effectCycleRef = (0, import_react115.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react116.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react116.useRef)(visible);
  useSafeLayoutEffect3(() => {
  ...
  const onFocus3 = (0, import_react116.useCallback)(() => {
...
function useForceUpdate2() {
  const unloadingRef = (0, import_react117.useRef)(false);
  const [count, setCount] = (0, import_react117.useState)(0);
  useUnmountEffect2(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react118.useState)(isOpen);
  const [once, setOnce] = (0, import_react118.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react119.useState)(initialState2);
  const callbacks = (0, import_react119.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  ...
  const [valueState, setValueState] = (0, import_react120.useState)(value);
  (0, import_react120.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react120.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react122.useState)(null);
  const rafId = (0, import_react122.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react123.cloneElement)(child, theming) : (0, import_react123.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react124.useMemo)(
    () => shouldWrapChildren ? import_react124.Children.map(children, (child, index) => (0, import_jsx_runtime71.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react125.useMemo)(
    () => getDividerStyles({ spacing, direction }),
    [spacing, direction]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react125.useMemo)(() => {
    const validChildren = getValidChildren(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react125.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime74.jsxs)(import_react125.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime80.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime80.jsx)(import_react126.Fragment, { children: chunk.text }, index);
  }) });
}
...
var Indicator = forwardRef(function Indicator2(props, ref) {
  ...
  const styles = (0, import_react127.useMemo)(
    () => ({
      display: "inline-flex",
      justifyContent: "center",
      alignItems: "center",
...
var AspectRatio = forwardRef(function(props, ref) {
  ...
  const child = import_react128.Children.only(children);
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react129.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react130.useState)([]);
  const timeoutRef = (0, import_react130.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react130.useEffect)(() => flush, []);
  function onKeyDown(fn2) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys];
...
function useEventListeners() {
  const listeners = (0, import_react131.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react131.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react131.useCallback)(
    (el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react132.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react132.useState)(false);
  ...
  const trulyDisabled = isDisabled2 && !isFocusable2;
  const handleClick = (0, import_react132.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.stopPropagation();
        event.preventDefault();
  ...
  const onDocumentKeyUp = (0, import_react132.useCallback)(
    (e) => {
  ...
  const handleKeyDown = (0, import_react132.useCallback)(
    (event) => {
  ...
  const handleKeyUp = (0, import_react132.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react132.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react132.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled2) {
  ...
  const handleMouseUp = (0, import_react132.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react132.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react132.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useFocusOnShow2(target, options = defaultOptions3) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react133.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react133.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
  ...
  const onFocus3 = (0, import_react133.useCallback)(() => {
    if (!visible || !element || !autoFocusRef.current)
      return;
    autoFocusRef.current = false;
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react134.useRef)(null);
  const popper2 = (0, import_react134.useRef)(null);
  const instance = (0, import_react134.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react134.useRef)(() => {
  });
  const setupPopper = (0, import_react134.useCallback)(() => {
    var _a2;
  ...
  const referenceRef = (0, import_react134.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react134.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react134.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react134.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react134.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react134.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react135.useState)(props.defaultIsOpen || false);
  const isOpen = isOpenProp !== void 0 ? isOpenProp : isOpenState;
  const isControlled = isOpenProp !== void 0;
  const uid = (0, import_react135.useId)();
  const id3 = idProp != null ? idProp : `disclosure-${uid}`;
  const onClose = (0, import_react135.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    handleClose == null ? void 0 : handleClose();
  }, [isControlled, handleClose]);
  const onOpen = (0, import_react135.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    handleOpen == null ? void 0 : handleOpen();
  }, [isControlled, handleOpen]);
  const onToggle = (0, import_react135.useCallback)(() => {
    if (isOpen) {
      onClose();
    } else {
      onOpen();
...
function useOutsideClick2(props) {
  ...
  const stateRef = (0, import_react136.useRef)({
    isPointerDown: false,
    ignoreEmulatedMouseEvents: false
  });
  const state = stateRef.current;
...
function useAnimationState2(props) {
  const { isOpen, ref } = props;
  const [mounted, setMounted] = (0, import_react137.useState)(isOpen);
  const [once, setOnce] = (0, import_react137.useState)(false);
...
function useMenu(props = {}) {
  ...
  const menuRef = (0, import_react138.useRef)(null);
  const buttonRef = (0, import_react138.useRef)(null);
  const descendants = useMenuDescendants();
  const focusMenu = (0, import_react138.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a2;
      (_a2 = menuRef.current) == null ? void 0 : _a2.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react138.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react138.useCallback)(() => {
    const id22 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react138.useCallback)(() => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react138.useState)(-1);
  useUpdateEffect(() => {
    if (!isOpen) {
      setFocusedIndex(-1);
    }
  ...
  const openAndFocusMenu = (0, import_react138.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react138.useRef)(/* @__PURE__ */ new Set([]));
  ...
  const openAndFocusFirstItem = (0, import_react138.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react138.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react138.useCallback)(() => {
    var _a2, _b;
  ...
  const rafId = (0, import_react138.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react138.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id3 = `${menuId}-menuitem-${(0, import_react138.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react138.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react138.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react138.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react138.useCallback)(
    (event) => {
  ...
  const onFocus3 = (0, import_react138.useCallback)(
    (event) => {
...
function useMenuOptionGroup(props = {}) {
  ...
  const onChange = (0, import_react138.useCallback)(
    (selectedValue) => {
  ...
  const clones = validChildren.map((child) => {
    ...
    return (0, import_react138.cloneElement)(child, {
      type,
      onClick,
      isChecked
    });
...
var Menu = (props) => {
  ...
  const context = (0, import_react139.useMemo)(() => ctx, [ctx]);
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react140.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react141.isValidElement)(child) ? (0, import_react141.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var ModalTransition = (0, import_react142.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react143.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react144.useRef)(null);
  const overlayRef = (0, import_react144.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react144.useRef)(null);
  const onMouseDown = (0, import_react144.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react144.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react144.useState)(false);
  const getDialogProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react144.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react150.useState)(false);
  const [action, setAction] = (0, import_react150.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react150.useState)(true);
  const timeoutRef = (0, import_react150.useRef)(null);
  ...
  const up = (0, import_react150.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react150.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react150.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const [isFocused, setFocused] = (0, import_react151.useState)(false);
  const isInteractive = !(isReadOnly || isDisabled2);
  const inputRef = (0, import_react151.useRef)(null);
  const inputSelectionRef = (0, import_react151.useRef)(null);
  const incrementButtonRef = (0, import_react151.useRef)(null);
  const decrementButtonRef = (0, import_react151.useRef)(null);
  const sanitize2 = (0, import_react151.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react151.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react151.useCallback)(
    (value) => {
      var _a2;
  ...
  const increment = (0, import_react151.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react151.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const _onFocus = (0, import_react151.useCallback)(
    (event) => {
      var _a2, _b, _c;
  ...
  const ariaValueText = (0, import_react151.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react151.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react151.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  }, [clampValueOnBlur, setFocused, validateAndClamp]);
  const focusInput = (0, import_react151.useCallback)(() => {
  ...
  const spinUp = (0, import_react151.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react151.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react151.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react151.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react152.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react153.useState)(true);
  const [focusedIndex, setFocusedIndex] = (0, import_react153.useState)(-1);
  ...
  const focusNext = (0, import_react153.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react153.useCallback)(
  ...
  const clear = (0, import_react153.useCallback)(() => {
    var _a2;
  ...
  const getNextValue = (0, import_react153.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react154.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react155.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function PopoverAnchor(props) {
  ...
  return (0, import_react157.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react158.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react158.useRef)(null);
  const focus2 = (0, import_react158.useCallback)(() => {
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react159.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react160.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react160.useState)(false);
  const [isFocused, setFocused] = (0, import_react160.useState)(false);
  const [isHovered, setHovering] = (0, import_react160.useState)(false);
  const [isActive, setActive] = (0, import_react160.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react160.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  (0, import_react160.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const handleChange = (0, import_react160.useCallback)(
    (event) => {
      if (isReadOnly || isDisabled2) {
        event.preventDefault();
        return;
  ...
  const onKeyUp = (0, import_react160.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react161.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime135.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react161.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react162.useRef)(true);
...
function usePrevious2(value) {
  const ref = (0, import_react163.useRef)();
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react165.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react166.useLayoutEffect : import_react166.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react166.useState)([]);
  const [count, setCount] = (0, import_react166.useState)(0);
...
function useRangeSlider(props) {
  ...
  const getOutputProps = (0, import_react167.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react168.useMemo)(
...
function useSlider(props) {
  ...
  const thumbRef = (0, import_react169.useRef)(null);
  ...
  const constrain = (0, import_react169.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react173.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react175.useRef)();
  const clearEnterTimeout = (0, import_react175.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react175.useRef)();
  const clearExitTimeout = (0, import_react175.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react175.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react175.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react175.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
    exitTimeout.current = win.setTimeout(closeNow, closeDelay);
  }, [closeDelay, closeNow, clearEnterTimeout]);
  const onClick = (0, import_react175.useCallback)(() => {
    if (isOpen && closeOnClick) {
      closeWithDelay();
    }
  }, [closeOnClick, closeWithDelay, isOpen]);
  const onPointerDown = (0, import_react175.useCallback)(() => {
  ...
  const getTriggerProps = (0, import_react175.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getTooltipPositionerProps = (0, import_react175.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react175.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    const child = import_react176.Children.only(children);
    trigger2 = (0, import_react176.cloneElement)(
      child,

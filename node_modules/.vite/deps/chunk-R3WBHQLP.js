...
var ElementHandle = (() => {
  ...
  var _a, _b, _c, _d, _e2, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7;
  ...
  return _a2 = class extends _classSuper {
    ...
    constructor(handle) {
       ...
       * @internal
       */
      __publicField(this, "handle", (__runInitializers2(this, _instanceExtraInitializers), void 0));
      this.handle = handle;
    ...
    static bindIsolatedHandle(target, _) {
      return async function(...args) {
        ...
        try {
          ...
          const adoptedThis = __addDisposableResource4(env_1, await this.frame.isolatedRealm().adoptHandle(this), false);
    ...
    async $eval(selector, pageFunction, ...args) {
      ...
      try {
        ...
        const elementHandle = __addDisposableResource4(env_2, await this.$(selector), false);
        if (!elementHandle) {
    ...
    async $$eval(selector, pageFunction, ...args) {
      ...
      try {
        ...
        const elements = __addDisposableResource4(env_3, await this.evaluateHandle((_, ...elements2) => {
          return elements2;
        }, ...results), false);
    ...
    async isIntersectingViewport(options = {}) {
      ...
      try {
        ...
        const target = __addDisposableResource4(env_6, handle && await __privateMethod(_a3 = handle, _getOwnerSVGElement, getOwnerSVGElement_fn).call(_a3), false);
    ...
    while (parentFrame = frame == null ? void 0 : frame.parentFrame()) {
      ...
      try {
        const handle = __addDisposableResource4(env_5, await frame.frameElement(), false);
        if (!handle) {
          throw new Error("Unsupported frame type");
        }
        const parentBox = await handle.evaluate((element) => {
    ...
    _$$_decorators = [throwIfDisposed(), (_e2 = _a2).bindIsolatedHandle.bind(_e2)];
    _$x_decorators = [throwIfDisposed(), (_f = _a2).bindIsolatedHandle.bind(_f)];
    _waitForSelector_decorators = [throwIfDisposed(), (_g = _a2).bindIsolatedHandle.bind(_g)];
    _isVisible_decorators = [throwIfDisposed(), (_h = _a2).bindIsolatedHandle.bind(_h)];
    _isHidden_decorators = [throwIfDisposed(), (_j = _a2).bindIsolatedHandle.bind(_j)];
    _waitForXPath_decorators = [throwIfDisposed(), (_k = _a2).bindIsolatedHandle.bind(_k)];
    _toElement_decorators = [throwIfDisposed(), (_l = _a2).bindIsolatedHandle.bind(_l)];
    _clickablePoint_decorators = [throwIfDisposed(), (_m = _a2).bindIsolatedHandle.bind(_m)];
    _hover_decorators = [throwIfDisposed(), (_o = _a2).bindIsolatedHandle.bind(_o)];
    _click_decorators = [throwIfDisposed(), (_p = _a2).bindIsolatedHandle.bind(_p)];
    _drag_decorators = [throwIfDisposed(), (_q = _a2).bindIsolatedHandle.bind(_q)];
    _dragEnter_decorators = [throwIfDisposed(), (_r = _a2).bindIsolatedHandle.bind(_r)];
    _dragOver_decorators = [throwIfDisposed(), (_s = _a2).bindIsolatedHandle.bind(_s)];
    _drop_decorators = [throwIfDisposed(), (_t = _a2).bindIsolatedHandle.bind(_t)];
    _dragAndDrop_decorators = [throwIfDisposed(), (_u = _a2).bindIsolatedHandle.bind(_u)];
    _select_decorators = [throwIfDisposed(), (_v = _a2).bindIsolatedHandle.bind(_v)];
    _tap_decorators = [throwIfDisposed(), (_w = _a2).bindIsolatedHandle.bind(_w)];
    _touchStart_decorators = [throwIfDisposed(), (_x = _a2).bindIsolatedHandle.bind(_x)];
    _touchMove_decorators = [throwIfDisposed(), (_y = _a2).bindIsolatedHandle.bind(_y)];
    _touchEnd_decorators = [throwIfDisposed(), (_z = _a2).bindIsolatedHandle.bind(_z)];
    _focus_decorators = [throwIfDisposed(), (_0 = _a2).bindIsolatedHandle.bind(_0)];
    _type_decorators = [throwIfDisposed(), (_1 = _a2).bindIsolatedHandle.bind(_1)];
    _press_decorators = [throwIfDisposed(), (_2 = _a2).bindIsolatedHandle.bind(_2)];
    _boundingBox_decorators = [throwIfDisposed(), (_3 = _a2).bindIsolatedHandle.bind(_3)];
    _boxModel_decorators = [throwIfDisposed(), (_4 = _a2).bindIsolatedHandle.bind(_4)];
    _screenshot_decorators = [throwIfDisposed(), (_5 = _a2).bindIsolatedHandle.bind(_5)];
    _isIntersectingViewport_decorators = [throwIfDisposed(), (_6 = _a2).bindIsolatedHandle.bind(_6)];
    _scrollIntoView_decorators = [throwIfDisposed(), (_7 = _a2).bindIsolatedHandle.bind(_7)];
...
var Locator = class extends EventEmitter {
  ...
  async waitHandle(options) {
    return await fe(this._wait(options).pipe(this.operators.retryAndRaceWithSignalAndTimer(options == null ? void 0 : options.signal)));
  }
  /**
  ...
  click(options) {
    return fe(__privateMethod(this, _click, click_fn).call(this, options));
  }
  /**
   ...
   */
  fill(value, options) {
    return fe(__privateMethod(this, _fill, fill_fn).call(this, value, options));
  }
  hover(options) {
    return fe(__privateMethod(this, _hover, hover_fn).call(this, options));
  }
  scroll(options) {
    return fe(__privateMethod(this, _scroll, scroll_fn).call(this, options));
  }
};
...
scroll_fn = function(options) {
  ...
  return this._wait(options).pipe(this.operators.conditions([
    ...
    }, options == null ? void 0 : options.scrollTop, options == null ? void 0 : options.scrollLeft)).pipe(kr((err) => {
      void handle.dispose().catch(debugError);
      throw err;
    }));
  }), this.operators.retryAndRaceWithSignalAndTimer(signal));
...
var _FunctionLocator = class _FunctionLocator extends Locator {
  ...
  _wait(options) {
    const signal = options == null ? void 0 : options.signal;
    return se(() => {
      return j(__privateGet(this, _pageOrFrame).waitForFunction(__privateGet(this, _func), {
...
var _FilteredLocator = class _FilteredLocator extends DelegatedLocator {
  ...
  _wait(options) {
    return this.delegate._wait(options).pipe(E((handle) => {
      return j(Promise.resolve(__privateGet(this, _predicate).call(this, handle, options == null ? void 0 : options.signal))).pipe(J((value) => {
        return value;
      }), k(() => {
        return handle;
      }));
...
var _MappedLocator = class _MappedLocator extends DelegatedLocator {
  ...
  _wait(options) {
    return this.delegate._wait(options).pipe(E((handle) => {
      return j(Promise.resolve(__privateGet(this, _mapper).call(this, handle, options == null ? void 0 : options.signal)));
    }));
  }
};
_mapper = new WeakMap();
...
var _NodeLocator = class _NodeLocator extends Locator {
  ...
  _wait(options) {
    const signal = options == null ? void 0 : options.signal;
    return se(() => {
      return j(__privateGet(this, _pageOrFrame2).waitForSelector(__privateGet(this, _selector), {
        visible: false,
        timeout: this._timeout,
        signal
      }));
      ...
      return value !== null;
    }), wr(), this.operators.conditions([__privateGet(this, _waitForVisibilityIfNeeded)], signal));
  }
};
...
var _RaceLocator = class _RaceLocator extends Locator {
  ...
  _wait(options) {
    return xe(...__privateGet(this, _locators).map((locator) => {
...
var Frame = (() => {
  ...
  return _a = class extends _classSuper {
    ...
    __esDecorate3(_a, null, _$$eval_decorators, { kind: "method", name: "$$eval", static: false, private: false, access: { has: (obj) => "$$eval" in obj, get: (obj) => obj.$$eval }, metadata: _metadata }, null, _instanceExtraInitializers);
    __esDecorate3(_a, null, _$x_decorators, { kind: "method", name: "$x", static: false, private: false, access: { has: (obj) => "$x" in obj, get: (obj) => obj.$x }, metadata: _metadata }, null, _instanceExtraInitializers);
    ...
    __esDecorate3(_a, null, _waitForXPath_decorators, { kind: "method", name: "waitForXPath", static: false, private: false, access: { has: (obj) => "waitForXPath" in obj, get: (obj) => obj.waitForXPath }, metadata: _metadata }, null, _instanceExtraInitializers);
...
var Page = (() => {
  var _requestHandlers, _screencastSessionCount, _startScreencastPromise, _getNativePixelDimensions, getNativePixelDimensions_fn, _a;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _screenshot_decorators;
  return _a = class extends _classSuper {
    ...
    async screencast(options = {}) {
      const [{ ScreenRecorder }, [width, height, devicePixelRatio]] = await Promise.all([
        import("./ScreenRecorder-X7X7DNLJ.js"),
      ...
      if (options.path) {
        const { createWriteStream } = await import("./fs-BVV56LNN.js");
    ...
    _getPDFOptions(options = {}, lengthUnit = "in") {
      ...
      const margin = {
        top: convertPrintParameterToInches((_a2 = options.margin) == null ? void 0 : _a2.top, lengthUnit) || 0,
...
var JSCoverage = class {
  ...
  async start(options = {}) {
    ...
    __privateGet(this, _subscriptions).use(new EventSubscription(__privateGet(this, _client2), "Debugger.scriptParsed", __privateMethod(this, _onScriptParsed, onScriptParsed_fn).bind(this)));
    __privateGet(this, _subscriptions).use(new EventSubscription(__privateGet(this, _client2), "Runtime.executionContextsCleared", __privateMethod(this, _onExecutionContextsCleared, onExecutionContextsCleared_fn).bind(this)));
    await Promise.all([
...
var CSSCoverage = class {
  ...
  async start(options = {}) {
    ...
    __privateGet(this, _eventListeners).use(new EventSubscription(__privateGet(this, _client3), "CSS.styleSheetAdded", __privateMethod(this, _onStyleSheet, onStyleSheet_fn).bind(this)));
    __privateGet(this, _eventListeners).use(new EventSubscription(__privateGet(this, _client3), "Runtime.executionContextsCleared", __privateMethod(this, _onExecutionContextsCleared2, onExecutionContextsCleared_fn2).bind(this)));
    await Promise.all([
...
var _frames, _parentIds, _childIds, _mainFrame, _waitRequests;
var FrameTree = class {
  constructor() {
  ...
  addFrame(frame) {
    ...
    (_a = __privateGet(this, _waitRequests).get(frame._id)) == null ? void 0 : _a.forEach((request) => {
  ...
  removeFrame(frame) {
    ...
    if (frame._parentId) {
      (_a = __privateGet(this, _childIds).get(frame._parentId)) == null ? void 0 : _a.delete(frame._id);
    } else {
...
puppeteer-core/lib/esm/puppeteer/cdp/FrameTree.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-R3WBHQLP.js.map

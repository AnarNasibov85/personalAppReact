...
import {
  require_browser
} from "./chunk-VE5F746C.js";
import {
  require_stream
} from "./chunk-WE7SRTSD.js";
import {
  __commonJS,
  __privateAdd,
  __privateGet,
...
var ScreenRecorder = (() => {
  ...
  return _a = class extends _classSuper {
    ...
    constructor(page, width, height, { speed, scale, crop, format, path } = {}) {
      ...
      __privateSet(this, _lastFrame, ie(xr(client, "Page.screencastFrame").pipe(Pe((event) => {
      ...
      }), be(2, 1), ge(([{ timestamp: previousTimestamp, buffer }, { timestamp }]) => {
        return j(Array(Math.round(DEFAULT_FPS * Math.max(timestamp - previousTimestamp, 0))).fill(buffer));
      }), k((buffer) => {
        void __privateGet(this, _writeFrame, writeFrame_get).call(this, buffer);
        return [buffer, performance.now()];
      }), Te(xr(__privateGet(this, _controller).signal, "abort"))), { defaultValue: [Buffer.from([]), performance.now()] }));
    }
    /**
     * Stops the recorder.
     *
...
puppeteer-core/lib/esm/puppeteer/node/ScreenRecorder.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QDXCRJLN.js.map
